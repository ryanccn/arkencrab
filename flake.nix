  ...
  outputs =
    ...
    in
    {
      checks = forAllSystems (
            ...
            pkgs.stdenv.mkDerivation (
              {
                ...
                src = self.packages.${system}.arkencrab.src;
        ...
        in
        {
          ...
          clippy = mkFlakeCheck {
            ...
            inherit (self.packages.${system}.arkencrab) cargoDeps;
            nativeBuildInputs = with pkgs; [
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            inputsFrom = [ self.packages.${system}.arkencrab ];
      ...
      packages = forAllSystems (
        ...
        in
        {
          inherit (packages) arkencrab;
          default = packages.arkencrab;
        }
      );
      ...
      overlays.default = _: prev: {
        arkencrab = prev.callPackage ./nix/package.nix { inherit self; };
      };
    };
}
